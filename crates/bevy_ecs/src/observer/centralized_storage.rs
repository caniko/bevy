...
impl Observers {
    ...
    fn propagate_defer_count(&mut self) {
        ...
        self.replace.defer_count = count;
    ...
    pub(crate) fn total_rebuild_order_calls(&self) -> u32 {
        let mut total = self.add.rebuild_order_call_count
            ...
            + self.replace.rebuild_order_call_count
    ...
    pub(crate) fn update_archetype_flags(
        ...
        if self.replace.contains_component_observers(component_id) {
    ...
    fn apply_observer_set_configs(&mut self, configs: &ObserverSetConfigs) {
        ...
        self.replace.configure_observer_sets(configs);
