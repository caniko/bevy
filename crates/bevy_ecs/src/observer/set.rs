...
impl IntoObserverConfigs<()> for Observer {
    fn into_configs(self) -> ObserverConfigs {
        ObserverConfigs::new(self)
    }
}
...
impl<E: Event, B: Bundle, I, Marker> IntoObserverConfigs<(E, B, Marker)> for I
where
    I: IntoObserverSystem<E, B, Marker>,
{
    fn into_configs(self) -> ObserverConfigs {
        ObserverConfigs::new(Observer::new(self))
    }
}
